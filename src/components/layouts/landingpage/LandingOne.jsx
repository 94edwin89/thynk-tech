      ...
      <div className=" grid grid-flow-col gap-5">
        <div className="flex-1 flex flex-col items-center w-full mb-8">
          <div className="relative mb-6">
            ...
            <button className="w-[195px] font-bold h-[65px] absolute bottom-[-1px] right-[-3px] bg-primary text-white py-2 px-4 rounded-xl hover:bg-[#28b1eb]">
              <Link to="/contact-us"> REACH OUT</Link>
            </button>
          </div>
        </div>

        <div className="reletive z-10 flex-1 flex-row w-full h-[280px]  bg-gray-100 p-6 rounded-lg shadow text-center">
