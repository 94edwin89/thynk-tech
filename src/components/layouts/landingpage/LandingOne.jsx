...
function LandingOne() {
  return (
    <section
      ...
      className=" bg-gray-0 p-8 rounded-lg flex flex-col items-center pt-[110px] h-[100vh] relative"
    >
     
      <div className="flex flex-col mb-8 w-full max-w-lg text-center md:text-left p-8">
