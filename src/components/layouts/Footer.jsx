    ...
    <div className='container-1200 mx-auto flex flex-col gap-3'>
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-8">
          <p className="uppercase light-text font-semibold hover:text-white">Follow Us : </p>
          <div className="flex items-center gap-5">
            {
              socialMediaLinks?.map((link) => (
                <a href={link.url} target="_blank" className="light-bg rounded-full p-2 group hover:bg-primary transition-colors duration-200">
                  <link.icon size={16} className="dark-text group-hover:text-white"/>
                </a>
              ))
            }
          </div>
