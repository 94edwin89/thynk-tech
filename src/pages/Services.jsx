...
const Services = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Our Services | Thynk Technologies - Innovative Web Development & IT Solutions
        </title>
        <meta
          name="description"
          content="Discover top-notch web development, mobile app solutions, and IT consulting services at Thynk Technologies."
        />
        <meta
          name="keywords"
          content="web development, mobile app development, IT consulting, software solutions, SEO services, Thynk Technologies"
        />
        <meta name="robots" content="index, follow" />
        <meta name="author" content="Thynk Technologies" />
        <meta property="og:title" content="Our Services - Thynk Technologies" />
        <meta
        ...
        <meta
          name="twitter:title"
          content="Our Services - Thynk Technologies"
        />
        <meta
      ...
      <div
        className="page-container flex flex-col overflow-hidden"
        id="web-dev"
      >
        {/* Header Section */}
        <div className="container-1200 grid grid-cols-1 md:grid-cols-2 gap-7 items-center mx-auto px-2">
          ...
          >
            ...
            <p className="text-lg dark-text">
              ...
              Whether you require desktop applications, mobile apps, or
              enterprise systems, we ensure scalable, robust, and future-proof
              software.
            </p>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-7 items-center my-10">
              ...
              >
                <h3 className="header-3">
                  ...
                  Building Exceptional Online Experiences
                </h3>
                <p className="text-lg dark-text">
                  ...
                  experience across all devices. Whether you need a simple
                  landing page, a complex eCommerce platform, or a custom web
                  application, our team is committed to delivering high-quality
                  web solutions tailored to your business goals.
                </p>
              </motion.div>
            </div>
          </div>
          ...
          <div className="container-1200 mx-auto flex flex-col gap-8 px-2 my-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-7 items-center">
              ...
              >
                ...
                <p className="text-lg dark-text">
                  <span className="text-4xl text-primary">A</span>t
                  ThynkTechnologies, we specialize in building cutting-edge
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-7 items-center">
              ...
              >
                ...
                <p className="text-lg dark-text">
                  ...
                  presence through expert SEO strategies designed to improve
                  your website&apos;s ranking on search engines. Our team
                  employs a combination of on-page optimization, technical SEO,
                  and quality content strategies to drive organic traffic and
