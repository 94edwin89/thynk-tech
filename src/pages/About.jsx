...
const About = () => {
  return (
    <div>
    <section className="about-us-section bg-white px-6 py-12">
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
    <img src={svg} className="absolute left-[3%] z-[1] w-[43%]"/>
          <div className='z-10'>
        <h3 className="text-green-500 text-lg font-bold mb-2">ABOUT US</h3>
        <h1 className="text-6xl font-extrabold leading-snug mb-6">
          We deliver the mission-critical IT services that move the world.
        </h1>
        <button className="text-white bg-green-500 px-6 py-3 rounded-full hover:bg-green-600 transition">
          GET STARTED
        </button>
      </div>
